            ...
            <div className="flex justify-between items-center py-6">
              ...
              <div className="flex items-center space-x-4">
                <nav className="flex space-x-4">
                  ...
                  <a href="/members" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                    Members
                  </a>
                  <a href="/transactions" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                    Transactions
                  </a>
